...
Para mantener la organización, cuando alguien elija una tarea, deberá comunicarlo (por ejemplo, en el grupo de WhatsApp) y si es posible, asignar su nombre junto a ella en el tablero del [Todo List](https://github.com/users/Julian-ops-vital/projects/1).
