...
- [ ] **Exportación visual del Horario:** (Opcional - MVP avanzado) Crear un botón que lea la tabla de tu horario y genere un diseño limpio listo para tomar captura o descargar a imagen para guardar en 
